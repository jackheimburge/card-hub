    ...
    return (
        <div>
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <input required name="category" id="category" value={card.category} onChange={handleChange} />
                ...
                <button disabled={isUploading} type="submit">{isUploading ? 'Loading..' : 'Submit'}</button>
            </form>
        </div>
    );
}
